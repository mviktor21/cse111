#Write a function named miles_per_gallon with three parameters named start, end, and gallons.

#Write a function named lp100k_from_mpg with one parameter named mpg.

#Write a function named main with no parameters which calls the other two functions.
